...
public class LoginSteps extends CommonMethods {
    ...
    public void the_user_enters_the_user_name_password_and_clicks_on_login_button_then_the_error_msg_is_verified(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String, String> data:datalist){
            ...
            String actualErrorMsg=loginPage.errorMsgField.getText();
            Assert.assertEquals(actualErrorMsg, expectedError);
            Thread.sleep(5000);
        }
    }
